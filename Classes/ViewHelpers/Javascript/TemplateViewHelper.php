...
namespace Iunctim\IuViewhelpers\ViewHelpers\Javascript;
...
class TemplateViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper {
     ...
     */
    public function render($templatePath,$forceOnTop = FALSE,$forceOnFooter=FALSE,$compress=FALSE,$excludeFromConcatenation=TRUE)
    {
